(function($){
	function crateCommentInfo(obj){
		 ...
		 * <div class="comment-info">
			<header><img src="./images/img.jpg" id="image_"+ obj.id +""></header>
		...
		var el = "<div class='comment-info' id='content_"+ obj.id +"'><header><img src='"+obj.img+"'></header><div class='comment-right'><h3>"+obj.replyName+"</h3>"
				+"<div class='comment-content-header'><span><i class='glyphicon glyphicon-time'></i>"+obj.time+"</span>";

		//if(typeof(obj.student) != "undefined" && obj.student != ""){
		//	el =el+"<div style='margin-top: -3%;margin-left: 20%;'>" +
		//		"<div class='progress'>" +
		...
		if(typeof(obj.address) != "undefined" && obj.browse != ""){
			el =el+"<span style='color: #FF6B0E;'><i class='glyphicon glyphicon-map-marker'></i>"+obj.address+"</span>";
		}
		...
		if(typeof(obj.osname) != "undefined" && obj.osname != ""){
			el =el+"<span style='margin-left: 14px;font-size: 14px;color: #0658ac;'><i class='glyphicon glyphicon-pushpin'></i> "+obj.osname+"</span>";
		}
		
		//if(typeof(obj.browse) != "undefined" && obj.browse != ""){
		//	el = el + "<span style='margin-left: 14px;font-size: 14px;color: #60AEFD;'><i class='glyphicon glyphicon-globe'></i> "+obj.browse+"</span>";
		//}

		
		el = el + "</div><div class='col-md-2'><a class='reply-btn1' id='reply_"+ obj.id +"' target='_blank' style='cursor: pointer'>回复</a>";

		el = el + "<a class='delete-btn' id='delete_"+ obj.id +"' style='cursor: pointer;margin-left: 10px;color: #9d0f0f99;'>删除</a></div></div></div><div class='reply-list'>";
