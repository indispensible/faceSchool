...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>jsp/common/css/style_1.css">
...
<div class="container1">
    <div class="commentbox">
        ...
        <%--<div class="btn btn-info pull-right" id="ban_comment" style="background-color: #eb7813;border-color: #eb7813;">禁止评论</div>--%>
        ...
        <%--<div>--%>
            ...
            <%--</div>--%>
        <%--</div>--%>
        <p id="reference" style="text-align: center;margin-bottom: -2.8%;font-size: 16.666px;color: #797878;">课程参考评价分数：100</p>
        <div class="btn btn-info pull-right" id="comment">评论</div>
        <div class="btn btn-info pull-right" id="comment_mining" style="margin-right: 10px;background-color: bisque;border-color: bisque;color: unset;" disabled="disabled">评论数太少</div>
        <%--<div class="btn btn-info pull-right" id="comment_mining" style="margin-right: 10px;background-color: bisque;border-color: bisque;color: unset;">评论词云</div>--%>
