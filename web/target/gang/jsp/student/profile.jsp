        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" novalidate id="lvgangde">
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">上财门户账号:</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <p class="lvgang" id="password" style="display: inline;"></p>
                            <span id="usernamelvgangde">(上财门户账号不可改变)</span>
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">人脸识别照片:</label>
                        <div class="col-sm-5">
                            <span id="imagetest">(人脸识别照片,如需修改请联系管理员，邮箱：m15801872696@163.com)</span>
...
<script src="<%=basePath%>js/student/profile.js"></script>
